...
parser.add_argument('--save_path', type=str, default='/home/yunjae_heo/workspace/ailab_mat/Parameters/supervision/imagenet30/box_loss/loss_4500')
...
if __name__ == "__main__":
    ...
    for i in range(0, args.epoch):
        ...
        if i == 30:
            select(episode, unselected, selected, avg_loss, K=4500)
