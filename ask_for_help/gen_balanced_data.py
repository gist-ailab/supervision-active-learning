...
s_path = '/ailab_mat/dataset/ISIC_skin_disease/balanced'
mode = 'val'
mask_path = '/ailab_mat/dataset/ISIC_skin_disease/Validation/ISIC-2017_Validation_Part1_GroundTruth'
mask_s_path = f'/ailab_mat/dataset/ISIC_skin_disease/balanced/mask_{mode}'
lbl_clss = ['bkl', 'nv', 'mel']
