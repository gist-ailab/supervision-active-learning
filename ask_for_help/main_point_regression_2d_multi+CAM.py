...
if args.mode=='point':
    ...
    for i in range(0, args.epoch2):
        point_regression4(i, model, reg_head, testloader1, criterion, criterion2, optimizer, optimizer2, device1)
        MaxAcc = regression_test4(i, model, testloader3, criterion, criterion2, device1, MaxAcc, save_path, reg_head)
